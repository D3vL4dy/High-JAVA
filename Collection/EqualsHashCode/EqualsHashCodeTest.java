...
//		p2.setName("이순신");
		...
		testSet.add(p1);
		testSet.add(p3);
//		System.out.println("Set의 size : " + testSet.size()); // Set은 중복 불가로 1
		testSet.add(p2);
...
//		
//		// 참조값(주소값)이 같은지 검사
//		if (this == obj) { // this : 현재 나
//			return true; // 참조값(주소값)이 같으면 같은 값이므로 무조건 true
//		}
//		
//		if(obj == null) {
//			return false;
...
//		}
//		
//		if(that.num == that.num && this.name.equals(that.name)) {
//			return true;
//		}
//		
//		return false;
