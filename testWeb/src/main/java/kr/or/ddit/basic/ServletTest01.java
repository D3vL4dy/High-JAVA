 ...
 * 
 * 이 예제는 배포 서술자(web.xml)를 이용해서 요청한 URL주소와 실행할 클래스를 연결해주는 예제
 */
public class ServletTest01 extends HttpServlet {
	private static final long serialVersionUID = 1L; // default값
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		// 처리한 결과를 출력한다.
		// 방법1 : append()메서드 이용하기
		out.append("<!DOCTYPE html>").append("<html>")
									.append("<head><meta charset='utf-8'>")
									.append("<title>첫 번째 서블릿</title></head>")
									.append("<body>")
									.append(a + " + " + b + " = " + c + "<br>")
									.append(a + " * " + b + " = " + (a * b) + "<br>")
									.append("</body></html>");
